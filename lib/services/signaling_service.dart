...
class SignalingService {
  ...
  void listenForIncomingCalls({
    ...
    required void Function(String callId, Map<String, dynamic> offer) onCallReceived,
  }) {
  ...
  void listenForOffer(String callId, void Function(Map<String, dynamic> offer) onOffer) {
  ...
  /// SDP answer 감시 (발신측)
  void listenForAnswer(String callId, void Function(Map<String, dynamic> answer) onAnswer) {
  ...
  void listenForCandidates(String callId, String path, void Function(Map<String, dynamic> candidate) onCandidate) {
  ...
  Future<String> createCall(Map<String, dynamic> offer, {required String targetDeviceId}) async {
  ...
  /// ICE candidate 추가
  Future<void> addCandidate(String callId, String path, Map<String, dynamic> candidate) async {
